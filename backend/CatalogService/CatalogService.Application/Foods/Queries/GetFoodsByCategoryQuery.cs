...
public record FoodDto(Guid Id, string Name, string? Description, string? ImageUrl, decimal Price, bool IsAvailable, Guid CategoryId);

public record GetFoodsByCategoryQuery(Guid CategoryId) : IRequest<List<FoodDto>>;
