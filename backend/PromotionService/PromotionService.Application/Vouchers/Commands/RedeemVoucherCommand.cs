...
public class RedeemVoucherCommandHandler : IRequestHandler<RedeemVoucherCommand, Guid>
{
    ...
    {
        // 1. READS OUTSIDE TRANSACTION (Fast & Optimistic)
        ...
        var existingVoucher = await _context.UserVouchers.AsNoTracking()
        ...
        var redemptionCount = await _context.UserVouchers.AsNoTracking()
        ...
        // 2. TRANSACTION (Short duration, only for writing Points and UserVouchers)
