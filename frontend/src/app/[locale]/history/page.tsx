...
export default function TransactionHistoryPage() {
    ...
    return (
        <div className="flex flex-col min-h-screen bg-[#FEF9E7] text-[#2D2D2D] selection:bg-primary selection:text-white relative font-main">
            ...
            <main className="flex-grow max-w-5xl mx-auto px-4 sm:px-6 pt-10 relative z-10 pb-32 w-full">
                ...
                <div className="mb-10">
                    <div className="flex items-center gap-3 mb-2">
                        <div className="size-9 rounded-lg bg-primary text-white flex items-center justify-center shadow-sm">
                            <Receipt size={18} />
                        </div>
                        <h1 className="font-display text-3xl md:text-4xl text-gray-900 uppercase tracking-tight">
                            Lịch sử đơn hàng
                        </h1>
                    </div>
                    ...
                    <Popover>
                        <PopoverTrigger asChild>
                            <Button
                                variant="outline"
                                className={cn(
                                    "justify-start text-left font-main text-sm border border-primary/30 bg-white rounded-xl h-10 min-w-[200px] hover:bg-primary/5 hover:border-primary/50 transition-all shadow-sm cursor-pointer",
                            ...
                            >
                                ...
                                {dateFilter && (
                                    <span
                                        role="button"
                                        className="ml-2 size-5 flex items-center justify-center rounded-full hover:bg-primary/10 text-gray-400 hover:text-primary transition-colors text-base leading-none cursor-pointer"
                                        onClick={(e) => {
                                            e.stopPropagation();
                        ...
                        <PopoverContent className="w-auto p-0 border border-primary/20 shadow-xl rounded-2xl overflow-hidden" align="end">
                            <Calendar
                                mode="single"
                                selected={dateFilter}
